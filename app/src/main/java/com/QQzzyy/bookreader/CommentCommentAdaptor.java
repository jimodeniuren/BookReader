...
public class CommentCommentAdaptor extends RecyclerView.Adapter<CommentListAdapter.ViewHolder>{
    ...
    public CommentCommentAdaptor(List<post> posts, Context context){
        mPostList = posts;
        CONTEXT = context;
    }
    ...
    public void onBindViewHolder(@NonNull final CommentListAdapter.ViewHolder holder, int position) {
        ...
        holder.commentorNeirong.setText(post.getContent());
